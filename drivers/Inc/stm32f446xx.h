 ...
 * e.g : Number of Registers of SPI peripheral of STM32F4x of family of MCUs may be different (more or less)
 * Compared to number of registers of peripheral of STM32Lx of STM32F0 family of MCUs
...
typedef struct {
	...
	__vo uint32_t OSPEEDER;          //port output speed register        //Address offset: 0x08
	...
	__vo  uint32_t AFR[2];            // AFR[0] alternate function low register, AFR[1] alternate function high register       //Address offset: 0x20 & 0x24
...
typedef struct{
	__vo uint32_t EXTI_IMR;         /*!< Give a short description,          	  	    Address offset: 0x00  */
	__vo uint32_t EXTI_EMR;         /*!< TODO,                						Address offset: 0x04      */
	__vo uint32_t EXTI_RTSR;        /*!< TODO,  									     Address offset: 0x08 */
	__vo uint32_t EXTI_FTSR;        /*!< TODO,  									     Address offset: 0x0C */
	__vo uint32_t EXTI_SWIER;       /*!< TODO,  									     Address offset: 0x10 */
	__vo uint32_t EXTI_PR;          /*!< TODO,  									     Address offset: 0x14 */
}EXTI_RegDef_t;
...
#define FMPI2C1_PCLK_DIS()    (RCC->APB1ENR &= ~(1<<24))
